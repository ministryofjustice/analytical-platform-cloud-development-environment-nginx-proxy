...
# Upgrade system packages to patch APK vulnerabilities (CVE-2026-19931, CVE-2026-18924, CVE-2026-76956, etc.)
RUN apk update && \
    apk add --no-upgrade "curl>=8.22.0-r0" "libcurl>=8.22.0-r0" "libexpat>=2.8.4-r0" && \
    rm -rf /var/cache/apk/*
