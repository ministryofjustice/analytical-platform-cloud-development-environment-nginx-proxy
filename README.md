...
```bash
docker pull --platform linux/amd64 docker.io/openresty/openresty:1.29.2.4-0-alpine-fat

docker image inspect --format='{{index .RepoDigests 0}}' docker.io/openresty/openresty:1.29.2.4-0-alpine-fat
```
